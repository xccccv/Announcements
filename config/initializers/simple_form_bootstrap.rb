...
SimpleForm.setup do |config|
  ...
  config
    .label_text = ->(label, required, _explicit_label) { "#{label} #{required}" }
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
      ba.wrapper tag: 'div',
                 class: 'd-flex flex-row'\
                        'justify-content-between align-items-center' do |bb|
  ...
  config.wrappers :inline_form, tag: 'span',
    ...
    b.optional :hint, wrap_with: { tag: 'small',
                                   class: 'form-text text-muted' }
  end
  ...
  #     ba.optional :prepend
  #     ba.use :input, class: 'form-control', error_class:
  #       'is-invalid', valid_class: 'is-valid'
  #     ba.optional :append
  #   end
  #   b.use :full_error, wrap_with: { tag: 'div',
  #                                 class: 'invalid-feedback d-block' }
